...
// Get Properties by Type (must come before :propertyId routes)
router.get(
  "/properties/:type",
  verifyAdmin,
...
// Get Property Details (specific property)
router.get(
  "/properties/:type/:propertyId",
  verifyAdmin,
...
router.put(
  "/properties/:type/:propertyId/occupant",
  verifyAdmin,
  [
...
router.post(
  "/properties/:type/:propertyId/reset-password",
  verifyAdmin,
  AdminController.resetPasswordToDefault
);
